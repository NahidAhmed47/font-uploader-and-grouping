...
const FileUploaderForm = () => {
  ...
  return (
    <div>
      <form  {...getRootProps()} className="w-[70%] mx-auto lg:w-auto lg:px-56 py-28 rounded-md border-dashed border-2 bg-gray-50 font-serif flex flex-col items-center gap-2 cursor-pointer">
        <input {...getInputProps()} />
